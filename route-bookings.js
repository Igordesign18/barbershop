...
const JOIN_SELECT = `
  SELECT
    ...
    b.service_id, b.barber_id, b.booking_date, b.booking_time,
    b.status, b.whatsapp_sent, b.created_at,
...
function toBookingJson(row) {
  return {
    ...
    services: row.service_id ? { name: row.service_name, price: row.service_price, duration: row.service_duration } : null,
